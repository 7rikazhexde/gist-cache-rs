...
=== ファイルをダウンロード中 ===
  ✓ ダウンロード完了: /home/user/Downloads/data_analysis.py

1件のファイルを/home/user/Downloadsに保存しました
```
...
Description: バックアップスクリプト #bash #backup
Files: backup.sh
...
=== ファイルをダウンロード中 ===
  ✓ ダウンロード完了: /home/user/Downloads/backup.sh
...
Description: セットアップスクリプト #bash #setup
Files: setup.sh
実行中: setup.sh (bash)
# ... (実行結果)

=== ファイルをダウンロード中 ===
  ✓ ダウンロード完了: /home/user/Downloads/setup.sh
...
```bash
# GistのIDを直接指定してダウンロード
$ gist-cache-rs run --download --id abc123def456

ID指定モード: abc123def456

Description: 便利なスクリプト #bash
Files: utility.sh
実行中: utility.sh (bash)
# ... (実行結果)

=== ファイルをダウンロード中 ===
  ✓ ダウンロード完了: /home/user/Downloads/utility.sh
